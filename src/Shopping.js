...
const food_data = [
    ...
    },
    {
      ...
      imageUrl:'https://www.pngitem.com/pimgs/m/4-44781_green-grapes-transparent-background-transparent-background-green-grape.png',
      price:'$1.35',
      amount:'lb'
    },{
      id:4,
...
const dep_data = [
  {
    index:1,
    name:'Beverages',
    imageUrl:'https://shop.pall.com/INTERSHOP/static/WFS/PALL-PALLUS-Site/-/PALL-PALLUS-pall-smb-responsive/en_US/subcategory-images/Juice.jpg'
  },
  {
    index:2,
    name:'Deli',
    imageUrl:'https://www.kuechengoetter.de/uploads/media/1800x1200/02/4282-pizza-margherita.jpg?v=1-0'
  },
  {
    index:3,
    name:'Meat',
    imageUrl:'https://www.credit.com/blog/wp-content/uploads/2016/04/butcher_shop.jpg'
  },
  {
    index:4,
    name:'Seafood',
  ...
  },
  {
    index:5,
    name:'Organics',
    imageUrl:'https://www.supermarketnews.com/sites/supermarketnews.com/files/styles/article_featured_retina/public/organicfruitsveggies.jpg?itok=0-JLqwoM'
  },
]  
const Shopping = () => {
  ...
  const listHeader = () => {
    ...
    return(
      <SafeAreaView style={{flex:1}}>
          ...
          <View style={{flex:1, flexDirection:"row",backgroundColor:"#131921", alignItems:"center", justifyContent:"space-around"}}>
          <Image style={{ width: 50, height: 50 , marginBottom:5, marginLeft:5, borderRadius:5}} source={require('./assets/lighthouse-logo.png')} />
              <Text style={{ fontSize:25, alignSelf:'center',color:'#C8CACC', letterSpacing:2, marginLeft:10, fontWeight:"bold" }}>
                      LightHouse
              </Text>
              
              <Image style={{ width: 30, height: 30 , tintColor:"white",}} source={require('./assets/user.png')}/>
              <Image style={{ width: 30, height: 30 , tintColor:"white"}} source={require('./assets/shopcard.png')}/>
              <Image style={{ width: 30, height: 30 , tintColor:"white"}} source={require('./assets/pagemenu.png')}/>
